...
\centerline{
{\large Groupe PCGI 21.1 \hspace{1.7 cm} --- Interrogation du --- \hspace{3.5 cm}  20/03/2017}}
...
\begin{enumerate}
\item Dans $\mathbb{R}^2$ donnez la définition d'une application linéaire.
\item Soit $f: \mathbb{R}^2 \longmapsto \R$ définie par $f(x,y) = x+y+1$.
