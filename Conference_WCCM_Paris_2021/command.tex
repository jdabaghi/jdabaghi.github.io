...
\nc{\etaNCKlcnki}{\eta_{\mathrm{NC},K,\phasel,\componentc}^{n,\kk,\ii}}
\nc{\etaNCKgcnki}{\eta_{\mathrm{NC},K,\phaseg,\componentc}^{n,\kk,\ii}}
\nc{\etaNCKghnki}{\eta_{\mathrm{NC},K,\phaseg,\componenth}^{n,k,i}}

\nc{\etaNCKpcnki}{\eta_{\mathrm{NC},K,\phasep,\componentc}^{n,k,i}}
\nc{\etaNAKcnki}{\eta_{\mathrm{NA},K,\componentc}^{n,\kk,\ii}}
\nc{\etaPKposnki}{\eta_{\mathrm{P},K,\mathrm{pos}}^{n,\kk,\ii}}
\nc{\etaPKnegnki}{\eta_{\mathrm{P},K,\mathrm{neg}}^{n,\kk,\ii}}
...
\nc{\etalinKcnki}{\eta_{\mathrm{lin},K,\componentc}^{n,\kk,\ii}}
\nc{\tildeetalinKcnki}{{\tilde \eta}_{\mathrm{lin},K,\componentc}^{n,k,i}}

\nc{\etaalgKcnki}{\eta_{\mathrm{alg},K,\componentc}^{n,\kk,\ii}}
...
\nc{\etaNCKchinki}{\eta_{\mathrm{NC},K,\chi}^{n,\kk,\ii}}
...
\nc{\hatPhtaunki}{{\widehat P}_{h \tau}^{n,k,i}}
...
\nc{\Shn}{S_h^n}
\nc{\ScKn}{{S}_{\componentc,K}^n}
\nc{\SwKn}{{S}_{\componentw,K}^n}
\nc{\ShKn}{{S}_{\componenth,K}^n}
...
\nc{\lwhtaunki}{l_{\componentw,h \tau}^{n,\kk,\ii}}
\nc{\lhhtaunki}{l_{\componenth,h \tau}^{n,k,i}}

\nc{\Phichtaunki}{{\bm \Phi}_{\componentc,h \tau}^{n,\kk,\ii}}
\nc{\Phiwhtaunki}{{\bm \Phi}_{\componentw,h \tau}^{n,\kk,\ii}}
\nc{\Phihhtaunki}{{\bm \Phi}_{\componenth,h \tau}^{n,\kk,\ii}}

\nc{\LcKnki}{\mathcal{L}_{\componentc,K}^{n,\kk,\ii}}

%% Unknowns during semi-smooth iterations
\nc{\Phnki}{P_{h}^{n,\kk,\ii}}
%\nc{\Plhnki}{P_{\mathrm{l},h}^{n,k,i}}
\nc{\Pghnki}{P_{h}^{\mathrm{g},n,k,i}}
\nc{\Shnki}{S_{h}^{n,\kk,\ii}}
\nc{\chihnki}{\chi_{h}^{n,\kk,\ii}}
...
\nc{\etaRKcnkinu}{\eta_{\mathrm{R},K,\componentc}^{n,\kk,\ii,\nuu}}

\nc{\etaFKcnkinu}{\eta_{\mathrm{F},K,\componentc}^{n,k,i,\nuu}}

\nc{\etaNAKcnkinu}{\eta_{\mathrm{NA},K,\componentc}^{n,\kk,\ii,\nuu}}

\nc{\etadiscKcnkinu}{\eta_{\mathrm{disc,K,\componentc}}^{n,k,i,\nuu}}


\nc{\etaremcKnkinu}{\eta_{\mathrm{rem},K,\componentc}^{n,\kk,\ii,\nuu}}
