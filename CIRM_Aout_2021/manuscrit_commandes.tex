...
%% DG framework
\newcommand*{\mean}[1]{\left\{\hspace{-0.05 cm} \left\{ #1 \right\} \hspace{-0.05 cm} \right\}_F}

\nc{\jump}[1]{[\hspace*{-0.05 cm}[ #1 ]\hspace*{-0.05 cm}]_F}
...
\nc{\tildlambhkia}{\tilde{\lambda}_{h,\ba}^{\kk,\ii}}
...
\nc{\Ndpint}{\mathcal{N}_{\mathrm{d}}^{\mathrm{int}}}
\nc{\Ndofp}{\mathcal{N}_{\mathrm{dof}}^p}
\nc{\Ndp}{\mathcal{N}_{\mathrm{d}}}
\nc{\Vdp}{\mathcal{V}_{\mathrm{d}}}
\nc{\Vdpint}{\mathcal{V}_{\mathrm{d}}^{\mathrm{int}}}
\nc{\Vdpext}{\mathcal{V}_{\mathrm{d}}^{\mathrm{ext}}}
...
\nc{\tildgialfhkia}{\tilde{g}_{\ialf h}^{\kk,\ii,\ba}}
...
\nc{\PzeroTh}{\mathbb{P}_0(\Th)}
\nc{\PtwoTh}{\mathbb{P}_2(\Th)}
\nc{\Eh}{\mathcal{E}_h}
\nc{\Vhint}{\mathcal{V}_h^{\mathrm{int}}}
\nc{\VKint}{\mathcal{V}_K^{\mathrm{int}}}
\nc{\VKext}{\mathcal{V}_K^{\mathrm{ext}}}
...
\nc{\tildePhnki}{{\tilde P}_{h}^{n,\kk,\ii}}
...
\nc{\tildechihnki}{{\tilde \chi}_{h}^{n,\kk,\ii}}
...
\nc{\sigialfhdiscnki}{{\bm \sigma}_{\ialf h,\mathrm{disc}}^{n,\kk,\ii}}
\nc{\rialfhnki}{r_{\ialf h}^{n,\kk,\ii}}
...
\nc{\sigialfhnki}{{\bm \sigma}_{\ialf h}^{n,\kk,\ii}}
...
\nc{\uialfhtaunki}{\uialfhtau^{n,\kk,\ii}}
