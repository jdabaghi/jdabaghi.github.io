...
Let $\Omega \subset \mathbb{R}^2$ be a smooth connected domain.
\\
\vspace*{0.1 cm}
$\mathcal{H}$ : Hilbert space, $\mathcal{K}_g$ : convex set
\\
\vspace*{0.1 cm}
$a: \mathcal{H} \times \mathcal{H} \rightarrow \mathbb{R}$: bilinear continuous form, $\ell : \mathcal{H} \rightarrow \mathbb{R}$ : linear continuous form
\begin{equation*}
